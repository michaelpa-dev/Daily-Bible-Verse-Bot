...
4. The tag triggers `.github/workflows/build.yml`.
5. `build.yml` builds/tests, packages the release artifact, publishes a GitHub Release, and attaches the asset (`daily-bible-verse-bot-vX.Y.Z.tar.gz`).
